...
public class LoginActivity extends AppCompatActivity {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, Utils.LOGIN,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            // Ubah response string ke jsonObject
                            ...
                            if (!jsonResponse){
                                ...
                                // Simpan data dari EditText (jika login benar) ke SharedPreference
                                Utils.editSP.putString("id_user",user);
                                Utils.editSP.putString("pass", pass);

                                // Simpan data dari webService / DB ke SharedPreference
    ...
    // Supaya Back keluar aplikasi tidak kembali ke SplashScreen
    @Override
