 ...
 */
public class AdapterDaftarBimbingan extends BaseAdapter {
    ...
    public AdapterDaftarBimbingan(Context activity, List<DaftarBimbinganObject> itemDaftarBimbingan) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //inflate
        View v = View.inflate(activity, R.layout.item_daftar_bimbingan, null);
