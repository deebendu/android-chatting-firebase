...
public class PostInformasiActivity extends AppCompatActivity {
    ...
    // Ambil gambar dan kompress gambar (dari library Android Bitmap)
    ...
    private void UnggahInformasi (final String topik, final  String deskripsi) {
        ...
        //tampilkan progress loading upload
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utils.UPLOADINFORMASI,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        // Hilangkan dialog loading unggah
                        loading.dismiss();
    ...
    // Ambil dari FileChooser atau Galeri
    ...
    public void setTopikInformasi () {
        ...
        //masukkan teks yang pernah diketik
        ...
        alertDialog.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // Ambil topiknya sesuai dg yg diketik di alertDialog dan pasang di TextView
        ...
        alertDialog.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // Ambil deskripsinya sesuai dg yg diketik di alertDialog dan pasang di TextView
