...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Panggil ID user dari SharedPreference dan set ke variable
...
//        Toast.makeText(MainActivity.this, "TOKEN FCM : "+Utils.sharedPreferences.getString("FcmToken",""), Toast.LENGTH_SHORT).show();
...
//                                Utils.clearPreference();
                                ...
                                // hapus semua key kecuali FcmToken
...
// Supaya Back, keluar aplikasi, masuk lagi mampir splash screen
// Setelah login, masuk main, back, tidak ke login lg tapi keluar aplikasi
    @Override
    public void onBackPressed() {

//        if(getIntent().getExtras()!=null && getIntent().getExtras().containsKey("isNotif")) {
//            super.onBackPressed();
//        }else {
            Intent keSplash = new Intent(MainActivity.this, SplashScreenActivity.class);
