...
//                      tutup refresh
    ...
    // ================================== VALIDASI DATA AKADEMIK (Dosen & Mahasiswa) ======================================
...
//                AlertDialog.Builder builder = new AlertDialog.Builder(this);
//                builder.setTitle("Validasi");
//                builder.setMessage("Apakah anda ingin validasi data akademik ini ?");
//                builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
//                    public void onClick(DialogInterface dialog, int id) {
//
//                        progressValidasi = new ProgressDialog(DataAkademikActivity.this);
//                        progressValidasi.setTitle("Progress Validasi");
//                        progressValidasi.setMessage("Tunggu Sebentar ...");
//                        progressValidasi.show();
//
//                        // input id data akademik ke method PostValidasi
//                        PostValidasi(itemDataAkademik.get(position).getIdDataAkademik());
//
//                        dialog.dismiss();
//                    }
//                });
...
//            AlertDialog.Builder builder = new AlertDialog.Builder(this);
//            builder.setTitle("Info");
//            builder.setMessage("Data akademik sudah divalidasi");
//            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
//                public void onClick(DialogInterface dialog, int id) {
//                    dialog.dismiss();
//                }
...
//            dialog.show();
    ...
    // ====================================== SET KOMENTAR DATA AKADEMIK BAGI DOSEN ===================================
    ...
    // ===================================== KIRIM VALIDASI DATA AKADEMIK BAGI DOSEN ===================================
...
//                            Intent keRiwayatBimbingan = new Intent(HasilBimbinganActivity.this, RiwayatBimbinganActivity.class);
//                            startActivity(keRiwayatBimbingan);

//                             reload data akademik
                            swipeRefreshLayout.post(new Runnable() {
                                @Override
                                public void run() {
                                    swipeRefreshLayout.setRefreshing(true);
    ...
    // ===================================== KIRIM VALIDASI DATA AKADEMIK ===================================

//    public void PostValidasi(final String id_dataAkademik) {
//
//        StringRequest postRequest = new StringRequest(Request.Method.POST, Utils.VALIDASIDATAAKADEMIK,
//                new Response.Listener<String>() {
//                    @Override
...
//
//                            JSONObject obj = new JSONObject(response);
//                            String konfirmasi = obj.getString("validasi");
//
//                            // hilangkan loading progress konfirmasi
//                            progressValidasi.dismiss();
//
...
//
//
//                            Toast.makeText(DataAkademikActivity.this, "Validasi " + konfirmasi, Toast.LENGTH_LONG).show();
//
//
//                        } catch (JSONException e) {
//                            e.printStackTrace();
...
//    }
    ...
    // ================================== HAPUS DATA AKADEMIK (Dosen & Mahasiswa) ======================================
