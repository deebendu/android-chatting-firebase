...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ambil dari penyimpanan SharedPreferences
...
//                String waktuAndroid = DateFormat.getDateTimeInstance().format(new Date());
...
// ============ TANGKAP PESAN BROADCAST DARI PUSH NOTIF =============
...
//                Toast.makeText(ChatActivity.this, "SAMPAI PESANNYA " + pesannya, Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(ChatActivity.this, "Pesan Terkirim : " + pesan, Toast.LENGTH_SHORT).show();
