...
public class AdapterChat extends ArrayAdapter<ChatObject> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // jika tipe pesan sama dengan nim kontak tipenya pesan diterima (dari partner)
        // jika berbeda maka tipenya pesan dikirim
        if(isiChat.get(position).getPengirimPesan().equals(idKontak)){

            // Untuk chat dari pengirim
