...
//        ImageView bgDataMhs = (ImageView) findViewById(R.id.BG_buatJadwal);
//        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.wisuda);
//        Bitmap blurredBitmap = BlurBuilder.blur(this, bitmap);
//        bgDataMhs.setImageBitmap(blurredBitmap);

        // PANGGIL ID MAHASISWA
...
//                            Toast.makeText(BuatDataActivity.this, "Json error" + e, Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(BuatDataActivity.this, "Gak konek karena .... " + error, Toast.LENGTH_SHORT).show();
