...
//    public static String TOKEN = "";
//    public static String KIRIMPESAN = "http://192.168.1.6/academico/sendChatmessage.php";
//    public static String LIHATPESAN = "http://192.168.1.6/academico/lihatPesan.php";
//
//    public static String LOGIN = "http://192.168.1.6/academico/login.php/";
//    public static String PENGUMUMAN = "http://192.168.1.6/academico/pengumuman.php";
//    public static String KONTAK = "http://192.168.1.6/academico/kontak.php";
//    public static String BIMBINGAN = "http://192.168.1.6/academico/mhsBimbingan.php";
//
//    public static String BUATJADWAL = "http://192.168.1.6/academico/buatJadwal.php";
//    public static String RIWAYATBIMBINGAN = "http://192.168.1.6/academico/riwayatBimbingan.php";
//
//    public static String DATAAKADEMIK = "http://192.168.1.6/academico/dataAkademik.php";
